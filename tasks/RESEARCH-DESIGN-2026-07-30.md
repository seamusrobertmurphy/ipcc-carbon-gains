> **SUPERSEDED, 2026-07-30. This is not the paper.**
>
> This document designs an investigation into why soil carbon pools are *excluded* from
> crediting. That is the inverse of the actual subject, which is the carbon *gains* those
> pools can now be credited for. It was set aside the same day it was written.
>
> The live framing is
...
> and the evidence base is [`EVIDENCE-BASE-2026-07-30.md`](EVIDENCE-BASE-2026-07-30.md).
>
> Retained only because sections 4 and 6 hold verified data-access intelligence (UNFCCC CRT
> parsing, registry access, spatial product asset IDs) that would be reusable if the
> exclusion question is ever taken up as a separate paper.

# Research design: the uncertainty gate on soil carbon crediting (SUPERSEDED)
