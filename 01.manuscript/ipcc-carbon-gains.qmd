---
title: "Countable is not beneficial: metric dependence in the IPCC Tier 1 soil carbon gain pathways for peatlands, coastal wetlands and improved grasslands"
date: today
author:
  - name: Seamus Murphy
...
::: callout-important
## Absolute fluxes cannot answer the question
...
## Reference stocks for mineral soils
...
## Emission factors for rewetted organic soils
...
## Emission factors for the drained counterfactual
...
## The benefit of rewetting organic soils
...
## The benefit is metric-dependent, not merely uncertain
...
## The benefit is not statistically secure
...
## Coastal wetlands: the pathway that escapes the duration cap
...
## Inland wetland mineral soils: a countable gain that is a net source
...
## Improved grassland: the mineral soil gain
...
## The nitrogen trap: a finite gain against a perpetual penalty
...
## The reference stocks are biased, not merely uncertain
...
### Does the bias sit where the land is?
...
ben$ws <- ws_zone_from <- ifelse(ben$zone == "Boreal/Temperate", "Temperate", ben$zone)
...
::: callout-important
## What multiplying by area does and does not establish
...
## Ireland: the national worked example
...
### A default that fails in both directions at once
...
### Rewetting Irish grassland peat, on Ireland's own factors
...
### Three estimates of one intervention
...
::: callout-warning
## Two Irish papers, one inventory, opposite signs
...
### The nitrogen trap under a measured national factor
...
### The improved-grassland factor is contested by Irish data
...
### The national soils map has no carbon stock for peat
...
### Ireland's own inventory, added up
...
ben$benefit <- round(ben$drained - ben$rewetted, 2)
ben$drained <- round(ben$drained, 2); ben$rewetted <- round(ben$rewetted, 2)

knitr::kable(ben, row.names = FALSE,
...
### How much Irish saltmarsh is exposed to the salinity gate
...
## Metric choice is doing work that the guidance treats as presentational
...
## A binary drained-rewetted factor is the wrong shape
...
## The defaults themselves are contested
...
## A default that fails in opposite directions on the same hectares
...
## The nutrient fallback is biased against a genuine gain
...
## The salinity gate is approximately right in location and wrong in form
...
## What this means for inventories and for crediting
...
## The European Union has just answered this question, and answered it against Tier 1
